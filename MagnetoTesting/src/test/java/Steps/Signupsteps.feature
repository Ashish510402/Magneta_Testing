Feature: Account Creation and Sign In
  ...
  Scenario: Create an account and sign in with valid credentials
    ...
    And Enter first name "design", last name "user", email "develop3@gmail.com", password "Testuse@123", confirmpassword = "Testuse@123"
  ...
  Scenario: Login with existing email id
    ...
    And Enter email "develop3@gmail.com" , password "Testuse@123"
